...
class Address_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		// Display the widget
			...
			if ( $title ) {
				echo '<h3 class="text-center text-white p-0 m-0">'. $title .'</h3>';
			...
			// Display text field
			if ( $address ) {
				echo '<li class="mb-0">' . $address . '</li>';
			}

			if ( $tel ) {
				echo '<li class="mb-0">
					<a class="mb-0" href="tel:'.$tel.'">Tel:+'.$tel.'</a>
				</li>';
			}
			if ( $phone ) {
				echo '<li class="mb-0">
					<a class="mb-0" href="tel:'.$phone.'">Phone:+'.$phone.'</a>
				</li>';
			}
			if ( $email ) {
				echo '<li class="mb-0">
					<a class="mb-0" href="mailto:'.$email.'">Email: '.$email.'</a>
				</li>';
			}
